  ...
  200: [
    {
      ...
      opsec: "High",
      opsecNote: "Пассивные запросы к API сброса паролей",
      localInstall: true,
      googleDork: false,
      registration: false,
      editUrl: false,
    ...
    },
    {
      ...
      opsec: "High",
      opsecNote: "Использует токены авторизации Google",
      localInstall: true,
      googleDork: false,
      registration: false,
      editUrl: false,
    ...
    },
    {
      ...
      opsec: "Low",
      opsecNote: "Запрос через веб-сервис Epieos",
      localInstall: false,
      googleDork: false,
      registration: false,
      editUrl: false,
  ...
  300: [
    {
      ...
      opsec: "Medium",
      opsecNote: "Локальный парсер множества сайтов",
      localInstall: true,
      googleDork: false,
      registration: false,
      editUrl: false,
    ...
    },
    {
      ...
      opsec: "Low",
      opsecNote: "Запросы к публичным нумерациям и доркам",
      localInstall: true,
      googleDork: true,
      registration: false,
      editUrl: false,
  ...
  400: [
    {
      ...
      opsec: "Medium",
      opsecNote: "Автоматический доменный сканер",
      localInstall: true,
      googleDork: false,
      registration: false,
      editUrl: false,
    ...
    },
    {
      ...
      opsec: "Low",
      opsecNote: "Внутренняя модель формата STIX 2.1",
      localInstall: false,
      googleDork: false,
      registration: false,
      editUrl: false,
  ...
  600: [
    {
      ...
      opsec: "Low",
      opsecNote: "Анализ публичных блокчейнов",
      localInstall: false,
      googleDork: false,
      registration: false,
      editUrl: false,
    ...
    },
    {
      ...
      opsec: "High",
      opsecNote: "Работает исключительно через Tor Daemon",
      localInstall: true,
      googleDork: false,
      registration: false,
      editUrl: false,
